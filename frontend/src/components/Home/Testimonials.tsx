            ...
            <div className="max-w-6xl mx-auto">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
                    {testimonials.map((t) => (
                        <div
                            key={t.name}
                            className="p-7 border border-gray-200 rounded-2xl bg-white dark:bg-gray-800 flex flex-col gap-4 animate-fade-up transition-all duration-200 hover:border-gray-300 hover:shadow-md"
                            style={{ animationDelay: t.delay }}
                        >
                            {/* Star Rating */}
                            <div className="flex gap-0.5">
                                {[...Array(5)].map((_, i) => (
                                    <svg style={{ fill: theme === "dark" ? "#fff" : "#111827" }} key={i} width="14" height="14" viewBox="0 0 14 14" aria-hidden="true">
